...
class HotelsController < ApplicationController
  ...
  # GET /hotels.json
  def index    
    @hotels = Hotel.order("RAND()").limit(10)
  ...
  private
    ...
    def hotel_params
      params.require(:hotel).permit(:title_fa, :title_en, :title_ar, :text_fa, :text_en, :text_ar, :city_id, :class_hotel_id, :hotel_facilities, :hotel_type, :offer,
